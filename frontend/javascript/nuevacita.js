$(document).ready(function(){
    var url = "http://localhost:3000/paciente/listar";
    var urlm = "http://localhost:3000/medico/listar";
    var urlcita = "http://localhost:3000/cita_medica/listar_fechas";
    var url_agendar = "http://localhost:3000/cita_medica/guardar";
    var id_pac;
    var id_med;
    ...
    $("#crear-cita").click(function(){        
        ...
        fetch(url_agendar, requestOptions)
        .then(function(response){
            responseClone = response.clone();
            return response.json();
        }) // Convertir la respuesta a JSON
